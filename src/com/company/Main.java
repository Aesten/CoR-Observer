...
import com.company.handlers.ExistingContentCheckRequestHandler;
import com.company.handlers.PolicyCheckRequestHandler;
import com.company.handlers.RenderContentHandler;
...
public class Main {
    public static void main(String[] args) {
        ...
        server.setInitialHandler(h1);
        server.attach(fileLogger);

        //Expected output:
        //Status 403: user is not authorized to access this content
        System.out.println(server.getRequest(new WebRequest("/dashboard", regularUser)));

        //Expected output:
        //Status 404: Page missing
        System.out.println(server.getRequest(new WebRequest("/dashboard/nonExistingPage", adminUser)));

        //Expected output:
        //Status 200: Dashboard content here
        System.out.println(server.getRequest(new WebRequest("/dashboard", adminUser)));

        //Expected output :
        //Status 200 : Home content here
        System.out.println(server.getRequest(new WebRequest("/home", regularUser)));
